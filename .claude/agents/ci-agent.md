...
- `configure-goalert-operator-pull-request.yaml`: PR validation
- `configure-goalert-operator-push.yaml`: Main branch builds
- `configure-goalert-operator-pko-pull-request.yaml`: PKO validation
- `configure-goalert-operator-pko-push.yaml`: PKO deployment
...
# tkn pipeline validate -f .tekton/configure-goalert-operator-pull-request.yaml
...
```text
CI Status: FAILING
Pipeline: configure-goalert-operator-pull-request
Stage: golangci-lint
Error: Exit code 1
